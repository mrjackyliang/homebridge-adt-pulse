  ...
  async startTest(): ADTPulseTestStartTestReturns {
    try {
      ...
      const instanceFunctions = [
        ...
        instance.setPanelStatus.bind(instance, 'off', 'away'),
        instance.setPanelStatus.bind(instance, 'away', 'stay'),
        instance.setPanelStatus.bind(instance, 'stay', 'night'),
        instance.setPanelStatus.bind(instance, 'night', 'off'),
